...
const ProjectCard = ({index, name, description, tags, image, source_code_link}) => {
  ...
  >
    ...
    <img 
     ...
     />
    <div className='abosolute inset-0 flex justify-end m-3 card-img_hover'>
      {/* duplicate the div for live link to project */}
      <div 
      onClick={() => window.open
        ...
        <h2 className={styles.sectionHeadText}>
         ...
         <div className='w-full flex '>
          ...
          >
           ...
           repositories and live demos in it. It reflects my ability to 
